...
export function create_header() {
    ...
    img_country.src = 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQay6rtQG9Mup3tUiOfYF_xe-' +
            '2pIHcIrI3bQf67rVItPl318-Ujp6n7Wh7Ikz4Nur0K6-4&usqp=CAU'
    ...
    signUpForm2.onsubmit = (e) => {
        ...
        if (email && password && name && surname && password_cheking && checkbox) {
            http
                .getData('/users')
                .then(res => {
                    const existingUser = res.find((user : User) => user.email === email);
